...
class CGAN():
    ...
    def sample_images(self, epoch):
        ...
        wandb.log({'cgan_generated_imgs': plt})
        plt.close()
...
if __name__ == '__main__':
    ...
    cgan = CGAN(config.latent_dim)
    cgan.train(epochs=config.epochs, batch_size=config.batch_size, sample_interval=config.save_interval)
