...
class GAN():
    def __init__(self):
        ...
        optimizer_discr = Adam(0.0003, 0.5)
...
#        model.add(LeakyReLU(alpha=0.2))
#        model.add(Flatten())
        model.add(Dense(128,kernel_initializer=RandomNormal(mean=0.0, stddev=2.0)\
...
#        model.add(LeakyReLU(alpha=0.2))
        ...
        model.add(Dense(np.prod(self.img_shape), activation='tanh',\
                        ...
                        bias_initializer=RandomNormal(mean=-0.01, stddev=0.01)))
