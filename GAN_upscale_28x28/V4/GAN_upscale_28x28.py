...
class GAN():
    def __init__(self):
        ...
        optimizer_discr = Adam(0.00002, 0.5)
...
#        fake = np.zeros((batch_size, 1))
        ...
        valid = np.full(shape=(batch_size,1),fill_value=0.98)
        fake = np.full(shape=(batch_size,1),fill_value=0.001)
...
#        r, c = 5, 5
        ...
        np.save("simulated_data/"+epoch+".npy",arr=gen_imgs)


if __name__ == '__main__':
    gan = GAN()
    gan.train(epochs=30000000, batch_size=2000, sample_interval=10)