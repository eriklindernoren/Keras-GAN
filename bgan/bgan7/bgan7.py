...
from tensorflow.keras.layers import BatchNormalization, Activation, ZeroPadding2D, Reshape, Conv2DTranspose
...
class BGAN():
    ...
    def build_generator(self):
        ...
        model.add(Reshape((5,5,1), input_shape=(25,)))
#        model.add(LeakyReLU(alpha=0.2))
#        model.add(BatchNormalization(momentum=0.8))
        model.add(Conv2DTranspose(filters=16,kernel_size=(3,3),activation="tanh",padding="same",strides=(2,2)))
        model.add(Conv2DTranspose(32,(2,2),activation="tanh",padding="same",strides=(2,2)))
        model.add(Conv2DTranspose(64,(3,2),activation="tanh",padding="same",strides=(2,2)))
        model.add(Flatten())
