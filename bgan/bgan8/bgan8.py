...
#        model.add(BatchNormalization(momentum=0.8))
        ...
        model.add(Conv2DTranspose(32,(2,2),activation="tanh",padding="same",strides=(2,1)))
        model.add(Conv2DTranspose(64,(3,2),activation="tanh",padding="same",strides=(2,1)))
        model.add(Flatten())
